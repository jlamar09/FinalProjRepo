...
def get_scatter_chart(entered_site,slider_range):
    ...
    if entered_site == 'ALL':
        ...
        # return the outcomes piechart for a selected site
        fig = px.scatter(filtered_df[mask][filtered_df[mask]["Launch Site"]==entered_site], x="Payload Mass (kg)", y="class", color="Booster Version Category",  
        title='Correlation between Playload and Success for :' + entered_site,
        )
        return fig
